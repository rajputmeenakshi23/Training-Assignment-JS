...
const productWithHighestPrice = productMaster.reduce((highestProduct, currentProduct) => {
    if (currentProduct.price > highestProduct.price) {
        return currentProduct;
    }
    return highestProduct;
}, { price: 0 });

console.log("Name of the product with the highest price:", productWithHighestPrice.name);
